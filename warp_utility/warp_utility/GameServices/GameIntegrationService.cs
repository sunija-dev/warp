...
namespace Blish_HUD {
    ...
    public class GameIntegrationService /*: GameService*/ {
        ...
        public static GameIntegrationService instance;
        ...
        public bool WarpHasFocus = false;
            ...
            set {
                ...
                */
                ...
                if (!(value == null || _gw2Process.MainWindowHandle == IntPtr.Zero))
                {
                    if (_gw2Process.MainModule != null)
                    {
                        _gw2ExecutablePath = _gw2Process.MainModule.FileName;
                    }
                }
                ...
                this.Gw2IsRunning = _gw2Process != null
                                 && WindowUtil.GetClassNameOfWindow(this.Gw2Process.MainWindowHandle) == (GW2_GAMEWINDOW_NAME);
            }
        }

        //private SettingCollection _gameIntegrationSettings;

        private string _gw2ExecutablePath;

        public string Gw2ExecutablePath => _gw2ExecutablePath;
        ...
        private void DefineSettings(/*SettingCollection settings*/) {
            ...
            if (_gw2ExecutablePath == UNDEFINED_EXECPATH) {
                _gw2ExecutablePath = GetGw2PathFromRegistry();
            }
        }
        ...
        public void TryAttachToGw2() {
            ...
            */
            ...
            this.Gw2Process = GetDefaultGw2ProcessByName();
        ...
        */
        ...
        public void Update() {
            ...
            if (this.Gw2IsRunning) {
                ...
                (WindowUtil.OverlayUpdateResponse Response, bool Minimized, int ErrorCode) updateResult  = default; // REMOVED THIS LINE HERE
